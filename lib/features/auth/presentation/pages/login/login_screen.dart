...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocListener<AppManager, AppManagerState>(
        listener: (context, state) {
          if (state.userCode != null) {
            _studentIdController.text = state.userCode ?? "";
          }
          if (state.userPassword != null) {
            _passwordController.text = state.userPassword ?? "";
          }
          if (state.isRememberMe &&
              state.userCode != null &&
              state.userPassword != null) {
            _cubit.toggleRememberMe(shouldRememberMe: true);
            _cubit.loginStudent(
